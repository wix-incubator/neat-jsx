import { activeEditor, selectedText, allText } from "./editor";
...
function isRangeContainedInJSXExpression(code: string, start: any, end: any) {
  try {
...
function findContainerPath(ast: t.Node, start: any, end: any) {
